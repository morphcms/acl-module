...
class AclBuilder
{
    ...
    private function createPermissions(array $permissions, string $module = null): void
    {
    ...
    private function formatEnumPermissions(string|array $enumPermissions): array
    {
    ...
    private function attachPermissionsToRoles(array $roles, array|string $permissions): void
    {
        if (empty($roles)) {
            return;
        }
